...
// TODO(4): This is currently a normal `ListAdapter`. It should be `PagedListAdapter`.
class CheeseAdapter(
    private val onItemClicked: (CheeseSummary) -> Unit
) : ListAdapter<CheeseSummary, CheeseViewHolder>(DIFF_CALLBACK) {
    ...
    override fun onBindViewHolder(holder: CheeseViewHolder, position: Int) {
        // TODO(5): `PagedListAdapter` might give us `null` as an item. Prepare for it.
